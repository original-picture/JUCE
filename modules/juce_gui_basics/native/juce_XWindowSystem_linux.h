...
namespace XWindowSystemUtilities
{
    ...
    */
    struct Atoms
    {
        ...
        Atom protocols, protocolList[3], changeState, state, userTime, activeWin, pid, windowType, windowState, windowStateHidden, windowStateSkipTaskbar, windowStateAbove,
